...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    ...
    return res.status(200).json(settings || { taxRate: 0.08 });
  }
  ...
  if (req.method === 'PATCH') {
    ...
    await sql`
      INSERT INTO business_settings (id, store_hours, delivery_radius_miles, tax_rate, contact_email, contact_phone, store_name, cash_app_tag, venmo_username, updated_at)
      VALUES ('business', ${storeHours}, ${deliveryRadiusMiles}, ${taxRate}, ${contactEmail}, ${contactPhone}, ${storeName}, ${cashAppTag}, ${venmoUsername}, NOW())
