...
enum SampleDataService {
    ...
    static let sampleProducts: [Product] = [
        ...
        Product(
            name: "Dog Treat Pack",
            productDescription: "Baked dog treats made with pet-safe ingredients. Perfect for your furry friend.",
            price: 5.99,
            imageURL: u("photo-1587300003388-59208cc962cb"), // dog treats
            category: ProductCategory.treat4Paws.rawValue,
            isFeatured: false,
            isSoldOut: false,
            isVegetarian: true
        ),
