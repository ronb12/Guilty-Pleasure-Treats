...
export declare enum IdentityAuthProviderProjectOwnedBy {
    User = "user",
    Neon = "neon"
}
export declare enum IdentityAuthProviderProjectTransferStatus {
    Initiated = "initiated",
    Finished = "finished"
}
export interface IdentityCreateIntegrationRequest {
...
export interface IdentityCreateIntegrationResponse {
    auth_provider: IdentitySupportedAuthProvider;
...
export interface IdentityCreateAuthProviderSDKKeysRequest {
    /** @pattern ^[a-z0-9-]{1,60}$ */
    project_id: string;
    auth_provider: IdentitySupportedAuthProvider;
}
export interface IdentityCreateNewUserRequest {
    /** @pattern ^[a-z0-9-]{1,60}$ */
    project_id: string;
    auth_provider: IdentitySupportedAuthProvider;
    /**
...
export interface IdentityCreateNewUserResponse {
    /** ID of newly created user */
    id: string;
}
export interface IdentityTransferAuthProviderProjectRequest {
    /** @pattern ^[a-z0-9-]{1,60}$ */
    project_id: string;
    auth_provider: IdentitySupportedAuthProvider;
}
export interface IdentityTransferAuthProviderProjectResponse {
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     * @secure
     */
    createProjectIdentityIntegration: (data: IdentityCreateIntegrationRequest, params?: RequestParams) => Promise<AxiosResponse<IdentityCreateIntegrationResponse, any>>;
    /**
     ...
     * @secure
     */
    createProjectIdentityAuthProviderSdkKeys: (data: IdentityCreateAuthProviderSDKKeysRequest, params?: RequestParams) => Promise<AxiosResponse<IdentityCreateIntegrationResponse, any>>;
    /**
     ...
     * @secure
     */
    transferProjectIdentityAuthProviderProject: (data: IdentityTransferAuthProviderProjectRequest, params?: RequestParams) => Promise<AxiosResponse<IdentityTransferAuthProviderProjectResponse, any>>;
    /**
     * No description
     *
     * @tags Auth
     ...
     * @secure
     */
    listProjectIdentityIntegrations: (projectId: string, params?: RequestParams) => Promise<AxiosResponse<ListProjectIdentityIntegrationsResponse, any>>;
    /**
     * No description
     *
     * @tags Auth
     ...
     * @secure
     */
    deleteProjectIdentityIntegration: (projectId: string, authProvider: IdentitySupportedAuthProvider, params?: RequestParams) => Promise<AxiosResponse<void, any>>;
    /**
