...
paths:
  ...
  /projects/{project_id}/permissions/{permission_id}:
    ...
    delete:
      ...
      description: Revokes project access from the user associated with the specified
        permission `id`. You can retrieve a user's permission `id` by listing project
        access.
      tags:
      - Project
  ...
  /projects/auth/create:
    post:
      ...
      tags:
      - Auth
      operationId: createProjectIdentityIntegration
      requestBody:
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/IdentityCreateIntegrationRequest"
        required: true
      responses:
        201:
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/IdentityCreateIntegrationResponse"
        default:
          $ref: "#/components/responses/GeneralError"
  /projects/auth/keys:
    post:
      ...
      tags:
      - Auth
      operationId: createProjectIdentityAuthProviderSDKKeys
      requestBody:
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/IdentityCreateAuthProviderSDKKeysRequest"
        required: true
      responses:
        201:
  ...
  /projects/auth/transfer_ownership:
    post:
      ...
      tags:
      - Auth
      operationId: transferProjectIdentityAuthProviderProject
      requestBody:
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/IdentityTransferAuthProviderProjectRequest"
        required: true
      responses:
        200:
          description: Transfer initiated. Follow the URL to complete the process
            in your auth provider's UI.
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/IdentityTransferAuthProviderProjectResponse"
        default:
          $ref: "#/components/responses/GeneralError"
  /projects/{project_id}/auth/integrations:
    get:
      ...
      tags:
      - Auth
      operationId: listProjectIdentityIntegrations
      parameters:
      - name: project_id
        in: path
        description: The Neon project ID
      ...
      responses:
        200:
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/ListProjectIdentityIntegrationsResponse"
        default:
          $ref: "#/components/responses/GeneralError"
  /projects/{project_id}/auth/integration/{auth_provider}:
    delete:
      ...
      tags:
      - Auth
      operationId: deleteProjectIdentityIntegration
      parameters:
      - name: project_id
        in: path
        description: The Neon project ID
    ...
    get:
      ...
      - name: search
        ...
        schema:
          type: string
      - name: sort_by
        description: Sort the branches by sort_field. If not provided, branches will
          be sorted by updated_at descending order
        in: query
        schema:
          type: string
          default: updated_at
  ...
  /projects/{project_id}/branches/{branch_id}/compare_schema:
    get:
      ...
      description: Compares the schema from the specified database with another branch's
        schema.
            ...
            application/json:
              ...
              example:
                ...
                - id: 42dafb46-f861-497b-ae89-f2bec54f4966
                  ...
                  total_duration_ms: 100
        204:
          description: Returned if the database doesn't exist or has already been
            deleted
        default:
          $ref: "#/components/responses/GeneralError"
  ...
  /projects/{project_id}/vpc_endpoints/{vpc_endpoint_id}:
    ...
    delete:
      ...
      responses:
        200:
          description: Removed the VPC endpoint restriction from the specified Neon
            project
        default:
          $ref: "#/components/responses/GeneralError"
            ...
            application/json:
              ...
              example:
                ...
                - id: fd11748e-3c68-458f-b9e3-66d409e3eef0
                  ...
                  total_duration_ms: 100
        204:
          description: Returned if the endpoint doesn't exist or has already been
            deleted
        default:
          $ref: "#/components/responses/GeneralError"
    patch:
  ...
  /organizations/{source_org_id}/projects/transfer:
    ...
    - name: source_org_id
      in: path
      description: The Neon organization ID (source org, which currently owns the
        project)
      required: true
      schema:
        type: string
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/EmptyResponse"
        406:
          description: Transfer failed - the target organization has too many projects
            or its plan is incompatible with the source organization. Reduce projects
            or upgrade the organization.
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/LimitsUnsatisfiedResponse'
        422:
          description: One or more of the provided project IDs have GitHub or Vercel
            integrations installed. Transferring integration projects is currently
            not supported
          content:
            application/json:
              schema:
  ...
  /organizations/{org_id}/vpc/region/{region_id}/vpc_endpoints/{vpc_endpoint_id}:
    ...
    get:
      ...
      responses:
        200:
          description: Returned the current status and configuration details of the
  ...
  /users/me/projects/transfer:
    post:
      ...
      responses:
        ...
        406:
          description: Transfer failed - the target organization has too many projects
            or its plan is incompatible with the source account. Reduce the number
            of projects or upgrade the target organization to increase its capacity.
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/LimitsUnsatisfiedResponse'
...
components:
  ...
  schemas:
        ...
        project:
          ...
          properties:
            settings:
              $ref: "#/components/schemas/ProjectSettingsData"
            name:
              description: The project name. If not specified, the name will be identical
    ...
    IdentitySupportedAuthProvider:
      ...
      - mock
      - stack
    IdentityAuthProviderProjectOwnedBy:
      type: string
      enum:
      - user
      - neon
    IdentityAuthProviderProjectTransferStatus:
      type: string
      enum:
      - initiated
      - finished
    IdentityCreateIntegrationRequest:
      type: object
      required:
      - auth_provider
      - project_id
      ...
      properties:
        ...
        role_name:
          type: string
    IdentityCreateIntegrationResponse:
      type: object
      required:
      - auth_provider
      ...
      properties:
        ...
        table_name:
          type: string
    IdentityCreateAuthProviderSDKKeysRequest:
      type: object
      required:
      - project_id
      - auth_provider
    ...
    IdentityTransferAuthProviderProjectRequest:
      ...
      properties:
        ...
        auth_provider:
          $ref: "#/components/schemas/IdentitySupportedAuthProvider"
    IdentityTransferAuthProviderProjectResponse:
      type: object
      required:
      - url
      properties:
    ...
    CursorPagination:
      type: object
      description: To paginate the response, issue an initial request with `limit`
        value. Then, add the value returned in the response `.pagination.next` attribute
        into the request under the `cursor` query parameter to the subsequent request
        to retrieve next page in pagination. The contents on cursor `next` are opaque,
        clients are not expected to make any assumptions on the format of the data
        inside the cursor.
      properties:
        next:
          type: string
  ...
  parameters:
    CursorParam:
      name: cursor
      description: A cursor to use in pagination. A cursor defines your place in the
        data list. Include `response.pagination.next` in subsequent API calls to fetch
